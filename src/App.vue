<template>
    ...
    <div class="container">
      ...
      <div class="flex items-center justify-between space-x-4 mt-4">
        <label class="w-full relative">
          <input
            class="relative py-2 pl-4 pr-96 rounded-md outline-none bg-transparent border border-violet dark:border-grey dark:bg-mainBlack placeholder:font-medium placeholder:text-base placeholder:leading-4 placeholder:text-[#C3C1E5] placeholder:dark:text-[#666] focus:dark:border-violet transition-colors duration-300 group"
            type="text"
          ...
          <svg
            ...
            <path
              class="fill-violet dark:fill-grey group-focus:dark:fill-violet transition-colors duration-300"
        ...
        <select class="rounded-md bg-violet p-2 w-full max-w-20 outline-none">
          <option value="all">All</option>
          <option value="completed">Completed</option>
          <option value="uncompleted">Uncompleted</option>
        </select>

        <button class="rounded-md bg-violet p-2">
          <svg
            width="22"
            height="22"
            viewBox="0 0 22 22"
      ...
      <div class="flex justify-center">
        <ul class="mt-8 max-w-lg mx-0 grow space-y-4">
          <li
            class="border-b border-violet p-4 flex items-center justify-between">
            <div class="flex items-center space-x-2">
              <input
                class="accent-violet p-1 outline-none w-6 h-6 rounded-sm border border-violet"
                type="checkbox" />
              <p class="font-medium text-xl leading-5">NOTE #1</p>
            </div>
            <div class="flex items-center space-x-2">
              <button>
                <svg
          ...
          <li
            ...
            <div class="flex items-center space-x-2">
              <input
                class="accent-violet p-1 outline-none w-6 h-6 rounded-sm border border-violet"
                type="checkbox" />
              <p class="font-medium text-xl leading-5">NOTE #2</p>
            </div>
            <div class="flex items-center space-x-2">
              <button>
                <svg
          ...
          <li
            ...
            <div class="flex items-center space-x-2">
              <input
                class="accent-violet p-1 outline-none w-6 h-6 rounded-sm border border-violet"
                type="checkbox" />
              <p class="font-medium text-xl leading-5">NOTE #3</p>
            </div>
            <div class="flex items-center space-x-2">
              <button>
                <svg
  ...
  <button
    class="bg-violet border-2 border-violet absolute bottom-8 right-[28%] p-3 rounded-full active:bg-grey transition-colors duration-300 group">
    <svg
